...
<div class="main-content">
    ...
    <div class="page-content">
        ...
        <div class="col-xxl-9">
            <div class="card">
                <form class="needs-validation" action="../model/voucher.php" method="post"  id="invoice_form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="input-light">
                                        <select class="form-control bg-light border-0 w-100" data-choices data-choices-search-false id="payment-category" required name="payment_category" >
                                            ...
                                            <?php foreach($action->fetchVoucherCategories('all') as $data){
                                ...
                                <div class="col-12">
                                    ...
                                    <div>
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea5" rows="3" placeholder="Do you want to make any Comment?" name="intiator_comment"></textarea>
                                    </div>
                                </div>
                            </div>
